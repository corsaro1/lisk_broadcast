...
var transaction = lisk.multisignature.signTransaction((myObj.transactions[i].transaction),
seed);
...
xhr.send("{\"signature\":{\"signature\""+":"+data+","+"\"transaction\":"+ "\""+(myObj.transactions[i].transaction.id)+"\""+"}}");
